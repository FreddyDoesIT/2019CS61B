package Project0; /******************************************************************************
 *  Compilation:  javac Project0.StdDraw.java
 *  Execution:    java Project0.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code Project0.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code Project0.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">Project0.StdDraw.java</a>
 ...
 *           Project0.StdDraw.setPenRadius(0.05);
 *           Project0.StdDraw.setPenColor(Project0.StdDraw.BLUE);
 *           Project0.StdDraw.point(0.5, 0.5);
 *           Project0.StdDraw.setPenColor(Project0.StdDraw.MAGENTA);
 *           Project0.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code Project0.StdDraw.line()} and {@code Project0.StdDraw.point()}
 *  draw lines and points; the methods {@code Project0.StdDraw.setPenRadius()}
 *  and {@code Project0.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code Project0.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   Project0.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code Project0.StdDraw.setPenRadius(0.025)} makes
 ...
 *  {@link Color} Project0.data type that is discussed in Chapter 3. Until then,
 ...
 *  For example, {@code Project0.StdDraw.setPenColor(Project0.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code Project0.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code Project0.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *  </ul>
 *  <p>
 *  You use the {@link Font} Project0.data type to specify the font. This allows you to
 ...
 *   Project0.StdDraw.setFont(font);
 *   Project0.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 *  You can use the following methods to add Project0.images to your drawings:
 *  <ul>
 ...
 *  {@code Project0.StdDraw.clear(Project0.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   Project0.StdDraw.setScale(-2, +2);
 *   Project0.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       Project0.StdDraw.clear();
 *       Project0.StdDraw.filledCircle(x, y, 0.05);
 *       Project0.StdDraw.filledCircle(-x, -y, 0.05);
 *       Project0.StdDraw.show();
 *       Project0.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
 ...
 *  Standard drawing is capable of drawing large amounts of Project0.data.
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code Project0.StdDraw.BLACK}, {@code Project0.StdDraw.BLUE}, {@code Project0.StdDraw.CYAN},
     * {@code Project0.StdDraw.DARK_GRAY}, {@code Project0.StdDraw.GRAY}, {@code Project0.StdDraw.GREEN},
     * {@code Project0.StdDraw.LIGHT_GRAY}, {@code Project0.StdDraw.MAGENTA}, {@code Project0.StdDraw.ORANGE},
     * {@code Project0.StdDraw.PINK}, {@code Project0.StdDraw.RED}, {@code Project0.StdDraw.WHITE}, and
     * {@code Project0.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Project0.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    *               Seems to have some issues loading Project0.images on some systems
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Project0.StdDraw)
        try {
            URL url = Project0.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
