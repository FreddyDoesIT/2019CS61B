 ...
 *  Compilation:  javac Project0.StdOut.java
 *  Execution:    java Project0.StdOut
 *
 *  Writes Project0.data of various types to standard output.
 *
 *************************************************************************/
...
public final class StdOut {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        // write to stdout
        Project0.StdOut.println("Test");
        Project0.StdOut.println(17);
        Project0.StdOut.println(true);
        Project0.StdOut.printf("%.6f\n", 1.0/7.0);
    }
