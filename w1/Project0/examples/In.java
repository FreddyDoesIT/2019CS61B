...
/*************************************************************************
 *  Compilation:  javac Project0.In.java
 *  Execution:    java Project0.In   (basic test --- see source for required files)
 *
 *  Reads in Project0.data of various types from standard input, files, and URLs.
 *
 *************************************************************************/
...
public final class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from Project0.In to StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from Project0.In to StdIn */
   ...
   /**
    ...
    /*** begin: section (2 of 2) of code duplicated from Project0.In to StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)Project0.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from Project0.In to StdIn */
   ...
   /**
     ...
     * <tt>new Project0.In(filename)</tt>.{@link #readAllInts()}
     */
    public static int[] readInts(String filename) {
        return new Project0.In(filename).readAllInts();
    }

   /**
     * Reads all doubles from a file
     * @deprecated Clearer to use 
     * <tt>new Project0.In(filename)</tt>.{@link #readAllDoubles()}
     */
    public static double[] readDoubles(String filename) {
        return new Project0.In(filename).readAllDoubles();
    }

   /**
     * Reads all strings from a file
     * @deprecated Clearer to use 
     * <tt>new Project0.In(filename)</tt>.{@link #readAllStrings()}
     */
    public static String[] readStrings(String filename) {
        return new Project0.In(filename).readAllStrings();
    }
    ...
    public static int[] readInts() {
        return new Project0.In().readAllInts();
    }
   ...
   /**
    ...
    public static double[] readDoubles() {
        return new Project0.In().readAllDoubles();
    }
   ...
   /**
    ...
    public static String[] readStrings() {
        return new Project0.In().readAllStrings();
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new Project0.In("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        in = new Project0.In("/n/fs/introcs/www/java/stdlib/InTest.txt");
        try {
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new Project0.In("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
