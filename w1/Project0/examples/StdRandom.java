 ...
 * discrete and continuous distributions, including Bernoulli, uniform, Gaussian, exponential,
 * pareto, Poisson, and Cauchy. It also provides method for shuffling an array or subarray.
 * <p>
...
public final class StdRandom {
  ...
  /**
   * Sets the seed of the pseudorandom number generator. This method enables you to produce the same
   * sequence of "random" number for each execution of the program. Ordinarily, you should call this
   * method at most once per program.
   *
   * @param s the seed
   */
   ...
   * @return a real number distributed according to the Gaussian distribution with mean <tt>mu</tt>
   * and standard deviation <tt>sigma</tt>
   */
   ...
   * @return a random integer from a geometric distribution with success probability <tt>p</tt>
   * @throws IllegalArgumentException unless <tt>p >= 0.0</tt> and <tt>p <= 1.0</tt>
   */
   ...
   * @return a random real number from a Pareto distribution with shape parameter <tt>alpha</tt>
   ...
   * @throws IllegalArgumentException if sum of array entries is not (very nearly) equal to
   *                                  <tt>1.0</tt>
   * @throws IllegalArgumentException unless <tt>probabilities[i] >= 0.0</tt> for each index
   *                                  <tt>i</tt>
   */
   ...
   * @throws IllegalArgumentException if <tt>frequencies[i]</tt> is negative for any index
   *                                  <tt>i</tt>
   * @throws IllegalArgumentException if sum of frequencies exceeds <tt>Integer.MAX_VALUE</tt>
   *                                  (2<sup>31</sup> - 1)
   */
   ...
   * @return a random real number from an exponential distribution with rate <tt>lambda</tt>
