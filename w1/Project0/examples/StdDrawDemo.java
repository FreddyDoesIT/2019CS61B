 ...
 * Project0.StdDraw at: http://introcs.cs.princeton.edu/java/15inout/
 *
 * The link above also provides additional Project0.examples like BouncingBall.java
 *
...
public class StdDrawDemo {
  ...
  /**
   * Stick a copy of the image in the dead center of the image, which is position (0, 0). Slowly
   * zoom in on the image, then zoom back out (but faster than we zoomed in).
   */
